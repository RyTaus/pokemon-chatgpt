...
Data.Pokemon = {"---", "Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon", "Charizard",
...
Data.Moves = { "---",  "Pound", "Karate Chop", "DoubleSlap", "Comet Punch", "Mega Punch", "Pay Day",
...
Status = {}
function Status.GetStatusName(dword)
	local status_result = nil
	if dword == 0 then --None
		status_result = "NONE"
	elseif dword < 8 then -- Sleep
		status_result = "Sleep"
	elseif dword == 8 then -- Poison
		status_result = "Poisoned"
	elseif dword == 16 then -- Burn
		status_result = "Burned"
	elseif dword == 32 then -- Freeze
		status_result = "Frozen"
	elseif dword == 64 then -- Paralyze
		status_result = "Paralyzed"
	elseif dword == 128 then -- Toxic Poison
		status_result = "Toxic"
	end
